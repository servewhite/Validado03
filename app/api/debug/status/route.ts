...
export async function GET() {
  const config = {
    slimpay: {
      ...
      webhookToken: process.env.SLIMPAY_WEBHOOK_TOKEN ? "Configurado" : "NAO CONFIGURADO",
      apiUrl: "https://api.slimpay.com.br",
    },
    utmfy: {
  ...
  return NextResponse.json({
    ...
    instructions: {
      ...
      slimpay: "Configure SLIMPAY_PUBLIC_KEY, SLIMPAY_SECRET_KEY e SLIMPAY_WEBHOOK_TOKEN nas variáveis de ambiente",
